  ...
  return (
    <div className="admin-layout">
      ...
      <div className="admin-mobile-header">
        <div className="brand-logo" style={{fontSize: '1.2rem', margin: 0}}>Classic <span className="pret">Perfumes</span></div>
      ...
      <aside className={`admin-sidebar ${isSidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-brand">
          <Link href="/">
            <h2 className="brand-logo">Classic <span className="pret">Perfumes</span></h2>
          </Link>
        ...
        <div className="sidebar-footer">
          <div className="footer-user">
            ...
            <div className="user-info">
              <span className="user-email">admin@classicperfumes.com</span>
            </div>
          </div>
